...
export const meta = {
  ...
  description:
    "A machine learning model to predict the confirmation probability of waitlisted train tickets, analyzing historical Indian Railways data to support better travel planning decisions.",
  image:
    "/images/Publication-2.png",
